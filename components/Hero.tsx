...
const Hero: React.FC = () => {
  return (
    <section id="home" className="relative h-screen flex items-center justify-center text-center overflow-hidden -mt-20 pt-20">
      <div className="absolute inset-0 bg-gradient-to-br from-slate-900 via-slate-900 to-[#005F6B] opacity-80 z-10"></div>
      <div 
      ...
      <div className="relative z-20 px-4 max-w-4xl mx-auto">
        <h1 className="text-5xl md:text-7xl lg:text-8xl font-extrabold text-white leading-tight mb-4">
          <span className="text-glow text-[#00A7C0]">Marea</span> <span className="text-[#C5A14E]">Agency</span>
        </h1>
        ...
        <a 
          href="#contact" 
          className="inline-block bg-[#00A7C0]/20 backdrop-blur-lg text-white font-bold py-3 px-8 rounded-full text-lg border border-[#00A7C0]/50 transition-all duration-300 hover:bg-[#00A7C0]/40 hover:border-[#00A7C0]/80 hover:shadow-[#00A7C0]/40 shadow-lg transform hover:scale-105"
        >
